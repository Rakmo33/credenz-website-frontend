        ...
        return(
            ...
            <div className="modal-login">
                ...
                <form onSubmit={ submitForm }>
                    ...
                    <div className="form-group">
                        <button type="submit" className="btn btn-primary btn-block btn-lg"><Link to="/profilepage" onClick={handleClose}>Log in Now</Link></button>
                    </div>
                    <p className="hint-text">Forgot Password?</p>
                    <p className="hint-text">Don't have an account? <Link to="/signup" onClick={handleClose}>Create one</Link></p>
                </form>
