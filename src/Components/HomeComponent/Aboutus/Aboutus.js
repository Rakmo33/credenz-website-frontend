            ...
            <Row className={classes.credenz}>
                <Col className={classes.content} sm={8}>
                   <div data-aos='fade-up'
                    ...
                    data-aos-duration='600'> <h3 className={classes.mid}>Credenz</h3>
                ...
                <Col  data-aos='zoom-in'
                    ...
                    data-aos-offset='300'
                    data-aos-easing='ease-in-sine'
                    data-aos-duration='600' className={classes.logo_pos} sm={4}>
            ...
            <Row className={classes.pisb}>
                ...
                <Col className={classes.content} sm={8}>
                   <div  data-aos='fade-up'
                        ...
                        data-aos-offset='200'
                        data-aos-easing='ease-in-sine'
                        data-aos-duration='600'> <h3 className={classes.mid}>PICT IEEE Student Branch (PISB)</h3>
