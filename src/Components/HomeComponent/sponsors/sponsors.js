  ...
  return(
    <Container fluid>
      ...
      <Row>
        ...
        <Col md={2} sm={4}><Sponsor url={"Byju's2.jpg"}></Sponsor></Col>
        <Col md={2} sm={4}><Sponsor url={'c3.jpg'}></Sponsor></Col>
        <Col md={2} sm={4}><Sponsor url={'codechef.jpg'}></Sponsor></Col>
        <Col md={2} sm={4}><Sponsor url={'finiq2.png'}></Sponsor></Col>
      </Row>
      {/* <Row>
