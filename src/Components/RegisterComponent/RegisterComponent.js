...
const Register = () => {
  ...
  const [events, setEvents] = useState([
    ...
    },
    {
      ...
      let defaultFormData = {
        name1: localStorage.getItem("user") ? JSON.stringify(user["name"]).replace(/\"/g, "") : "",
        name2: "",
        name3: "",
        name4: "",
        year: undefined,
        number1: localStorage.getItem("user") ? JSON.stringify(user["phoneno"]).replace(/\"/g, "") : "",
        number2: undefined,
        email1: localStorage.getItem("user") ? JSON.stringify(user["email"]).replace(/\"/g, "") : "",
        email2: "",
        isMember: undefined,
        college: localStorage.getItem("user") ? JSON.stringify(user["email"]).replace(/\"/g, "") : "",
        events: {},
      };
