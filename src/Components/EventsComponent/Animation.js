  ...
  return (
    <div className='eve-anim'>
      <div className='container'>
        <svg
          aria-labelledby='moneytitle'
          className='money-sm money'
          id='Layer_1'
        ...
        {/* <div className='fallback iconCircle'>
          <img
            alt='.'
            src='https://s3-us-west-2.amazonaws.com/s.cdpn.io/28963/info-fallback.png'
          />
        </div> */}
        <svg
          ...
          <svg
            ...
            S236,129.1,222.1,129.1z'
                ...
                <linearGradient
                  ...
                  x2='320.3311'
                  y2='-5.3131'
                  gradientTransform='matrix(1.032 -0.177 0.169 0.987 -62.731 55.81)'>
                  <stop
                    offset={0}
                    style={{ stopColor: "#000707", stopOpacity: 0 }}
                  />
                  <stop
                    offset='4.700000e-02'
                    style={{
                      stopColor: "#182323",
                      stopOpacity: "4.700000e-02",
                    }}
                  />
                  <stop
                    offset='0.134'
                    style={{ stopColor: "#3E5250", stopOpacity: "0.134" }}
                  />
                  <stop
                    offset='0.227'
                    style={{ stopColor: "#617B79", stopOpacity: "0.227" }}
                  />
                  <stop
                    offset='0.324'
                    style={{ stopColor: "#7E9D9A", stopOpacity: "0.324" }}
                  />
                  <stop
                    offset='0.426'
                    style={{ stopColor: "#95B9B6", stopOpacity: "0.426" }}
                  />
                  <stop
                    offset='0.536'
                    style={{ stopColor: "#A7CFCB", stopOpacity: "0.536" }}
                  />
                  <stop
                    offset='0.657'
                    style={{ stopColor: "#B4DEDA", stopOpacity: "0.657" }}
                  />
                  <stop
                    offset='0.796'
                    style={{ stopColor: "#BCE7E3", stopOpacity: "0.796" }}
                  />
            ...
            c-20.9-17.9-52-20.5-75.9-4.4C180.9,104.7,176.6,108.6,173,112.9L173,112.9z'
               ...
               M168.4,156.9l-3.7,0.2c1.9,30.7,27.9,54.1,58.5,52.8l-0.1-3.7C194.4,207.4,170.1,185.5,168.4,156.9z'
                ...
                <path
                  className='st13'
                  d='M212.1,118.2l1.6-1.2L182.6-16.9C87.4,3,65.8,77.4,65.8,77.4s115.8,56.1,121.7,59.2l2.5-1.9
            C194.6,126.7,202.4,120.4,212.1,118.2L212.1,118.2z'
                ...
                <path
                  className='st15'
                  d='M258.6,143.1c-5.7-18.9-24.7-30.2-43.7-26.8L175.5-53.3l-1.2,0.3l39.6,170.8l0.6-0.1
            ...
            C187.8,136.2,187.7,136.2,187.7,136.2z M187.7,136.2C187.7,136.2,187.7,136.3,187.7,136.2z'
                ...
                <linearGradient
                  ...
                  x2='99.1097'
                  y2='359.7987'
                  gradientTransform='matrix(-0.386 0.973 0.902 0.357 -224.18 -59.782)'>
                  <stop
                    offset={0}
                    style={{ stopColor: "#000707", stopOpacity: 0 }}
                  />
                  <stop
                    offset='0.947'
                    style={{ stopColor: "#000101", stopOpacity: "0.947" }}
                  />
          ...
          <g id='highlight'>
            <path
              ...
              strokeWidth={2}
              strokeMiterlimit={10}
              d='M222.3-12v128.7h.1v184.6c0 15.5 12.7 28.1 28.4 28.2 15.7 0 28.3-12.6 28.4-28.2L278-12h-55.7z'
            />
          </g>
        ...
        <div className='allDialogs'>
          <article className='dialog d1'>
            ...
            <p>
              Plant trees &amp; plants to absorb more CO
              <span className='sub'>2</span>, reduce tropical deforestation.
            </p>
          </article>
          {/*dialog*/}
          <article className='dialog d2'>
            <h3>Biochar</h3>
            <p>
              Convert waste vegetation - leaves, straw, etc. - into charcoal
              &amp; bury.
            </p>
          </article>
          {/*dialog*/}
          <article className='dialog d3'>
            <h3>B.E.C.S.</h3>
            <p>
              Burn biomass for fuel. Capture the resulting CO
              <span className='sub'>2</span> &amp; bury it.
            </p>
          </article>
          {/*dialog*/}
          <article className='dialog d4'>
            ...
            <p>
              Separate out industrial CO<span className='sub'>2</span> &amp;
              bury it undergroud in old oil wells.
            </p>
          </article>
          {/*dialog*/}
          <article className='dialog d5'>
            ...
            <p>
              Paint roofs, roads, &amp; pavements bright white to reflect lots
              of sunlight.
            </p>
          </article>
          {/*dialog*/}
          <article className='dialog d6'>
            ...
            <p>
              Use giant towers &amp; artificial trees to scrub pure CO
              <span className='sub'>2</span> from the air.
            </p>
          </article>
          {/*dialog*/}
          <article className='dialog d7'>
            ...
            <p>
              Accelerate natural CO<span className='sub'>2</span> absorption by
              rocks by adding minerals to soil.
            </p>
          </article>
          {/*dialog*/}
          <article className='dialog d8'>
            ...
            <p className='smaller'>
              Stir megatonnes of limestone into oceans so more CO
              <span className='sub'>2</span> is absorbed by less acidic waters.
            </p>
          </article>
          {/*dialog*/}
          <article className='dialog d9'>
            ...
            <p>
              Air-spray particles of sea salt to make clouds whiter &amp;
          ...
          <article className='dialog d10'>
            ...
            <p>
              Add iron filings to surface water &amp; boost growth of CO
              <span className='sub'>2</span> - absorbing algae.
            </p>
          </article>
          {/*dialog*/}
          <article className='dialog d11'>
            ...
            <p className='smaller'>
              Scatter sulphate particles high in the atmosphere to reflect
              sunlight &amp; lower heat.
            </p>
          </article>
          {/*dialog*/}
          <article className='dialog d12'>
            ...
            <p>
              Launch thousands of orbiting mirrors to divert sunlight away from
              the surface.
            </p>
          </article>
          {/*dialog*/}
          ...
          <article className='dialog d14'>
            ...
            <p>
              Fill the atmosphere with terratonnes of soot, dropping
              temperatures.
            </p>
          </article>
          {/*dialog*/}
